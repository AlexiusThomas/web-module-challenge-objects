...
function createMenuItem(name, price, cateory){
  let newObject = {
    name : name,
    price : price,
    cateory : cateory,
...
const sammies = createMenuItem('sammies', 8, 'Lunch')
console.log(coffee);
console.log(tacos);
console.log(sammies);
...
const burger = {
  ...
  discount: function(person){
    ...
    if("teacher" ||  "student"){
      ...
      this.price - this.price * .25  ===  newPrice;
      return newPrice
    }else{
      this.price - this.price  * .1 === newPrice;
      return newPrice;
    }
    }
  }
...
for(let i = 0; i < reviews.length; i++) {
  if(reviews[i].feedback === "Absolutely love that they have karaoke Fridays! Food and drink selection is okay.") {
...
function getReviewByIndex(array, number) {
  return `${array[number].name} gave the restaurant a${rating} star review, and their feedback was: Beautiful atmosphere and wonderful vegan options!"`
}

// console.log(getReviewedByIndex(reviews, 5));  
